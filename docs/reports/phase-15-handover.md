...
| Player search, 1M synthetic rows                               | exact 44.2 ms median / 921 ms p95; text 70.1 ms median / 1,074.2 ms p95 — **p95 corrected in Phase 16 to 37.0 ms and 66.0 ms; the old figures were the cold first query reported as a percentile** | `bench-player-search.mjs 1000000` |
