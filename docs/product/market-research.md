...
| 8   | Honest evaluation: no "brilliant", no incomparable accuracy             | Chess.com-Brilliant, ChessMind (Dennis)     | labels            | **yes** — facts with denominators, by rule; no invented score in the daily session, no streak, no rating-gain (Phase 78)                                                                                                                                                                      |
