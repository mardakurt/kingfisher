...
| Bundled Kingfisher Starter (~177,511 games).                                                      | Landing, install guide, README | `public/reference/kingfisher-starter/manifest.json`; the bundled pack is a static asset.                                                                                                                 |
