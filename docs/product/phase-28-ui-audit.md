...
> Every assertion in this document is a *commitment* to verify in
...
mutation tests. Each "mutation" means the *opposite* of the
...
pass. LOOK AT THE UI."** This document is the *opposite* of a
