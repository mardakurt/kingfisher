...
| Landing hero from a real capture  | `scripts/landing-captures.mjs`, `public/landing/img/workspace-2026-09-23.webp` | `docs:check`, `e2e/landing-chrome.spec.ts`                     | recaptured for 1.1.1; all three images and the social card recaptured in Phase 71 by one script; in both Studio themes in Phase 84 | Held   |
