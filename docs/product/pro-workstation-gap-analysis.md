...
| Strategic theme search             | **Still missing**   | Phase 11 did not extend structural search to piece and material motifs (opposite-coloured bishops, rook endings, IQP, hanging pawns). The infrastructure is there; the themes are not. |
