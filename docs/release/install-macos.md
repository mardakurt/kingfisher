...
Kingfisher 1.2.2 for macOS is signed with a **Developer ID** certificate
...
The file is **`Kingfisher-1.2.2-arm64.dmg`**. If the file you downloaded
...
`ab8fa1a68071e1138ce28846b2624af7bf8b80fe7adfe5663669ea3a43238967`

To check yours:

```bash
shasum -a 256 ~/Downloads/Kingfisher-1.2.2-arm64.dmg
```
...
Double-click `Kingfisher-1.2.2-arm64.dmg` in your Downloads folder. A
...
system-wide setting to change; if a genuine Kingfisher 1.2.2 download
