...
Kingfisher 1.2.4 for macOS is signed with a **Developer ID** certificate
...
The file is **`Kingfisher-1.2.4-arm64.dmg`**. If the file you downloaded
...
`a66337788f5b4cd7fd843d828670b1e4b5ed8e026777faf5f4b6bd328b624109`

To check yours:

```bash
shasum -a 256 ~/Downloads/Kingfisher-1.2.4-arm64.dmg
```
...
Double-click `Kingfisher-1.2.4-arm64.dmg` in your Downloads folder. A
...
system-wide setting to change; if a genuine Kingfisher 1.2.4 download
