...
Kingfisher 1.1.9 for macOS is signed with a **Developer ID** certificate
...
The file is **`Kingfisher-1.1.9-arm64.dmg`**. If the file you downloaded
...
`6e101dae2350056dce4047a000c28bb9b33937e021cb84d9c99035e55f865ec0`

To check yours:

```bash
shasum -a 256 ~/Downloads/Kingfisher-1.1.9-arm64.dmg
```
...
Double-click `Kingfisher-1.1.9-arm64.dmg` in your Downloads folder. A
...
system-wide setting to change; if a genuine Kingfisher 1.1.9 download
