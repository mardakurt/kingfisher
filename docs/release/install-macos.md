...
Kingfisher 1.2.3 for macOS is signed with a **Developer ID** certificate
...
The file is **`Kingfisher-1.2.3-arm64.dmg`**. If the file you downloaded
...
`63204418206c9336c06876ea926d5e48067e2547d5dd35771d4271bd85b2410d`

To check yours:

```bash
shasum -a 256 ~/Downloads/Kingfisher-1.2.3-arm64.dmg
```
...
Double-click `Kingfisher-1.2.3-arm64.dmg` in your Downloads folder. A
...
system-wide setting to change; if a genuine Kingfisher 1.2.3 download
