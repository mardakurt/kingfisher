...
Kingfisher 1.1.8 for macOS is signed with a **Developer ID** certificate
...
The file is **`Kingfisher-1.1.8-arm64.dmg`**. If the file you downloaded
...
`24050a33d7903e1f8cb0a5848b5ce44cee2f63c7d9a6878981162438edcaa190`

To check yours:

```bash
shasum -a 256 ~/Downloads/Kingfisher-1.1.8-arm64.dmg
```
...
Double-click `Kingfisher-1.1.8-arm64.dmg` in your Downloads folder. A
...
system-wide setting to change; if a genuine Kingfisher 1.1.8 download
