...
Kingfisher 1.1.6 for macOS is signed with a **Developer ID** certificate
...
The file is **`Kingfisher-1.1.6-arm64.dmg`**. If the file you downloaded
...
`57b4a6225b81151038bfb688220ce3ad8af63f1462622fb7c45570ee73f9b81e`

To check yours:

```bash
shasum -a 256 ~/Downloads/Kingfisher-1.1.6-arm64.dmg
```
...
Double-click `Kingfisher-1.1.6-arm64.dmg` in your Downloads folder. A
...
system-wide setting to change; if a genuine Kingfisher 1.1.6 download
