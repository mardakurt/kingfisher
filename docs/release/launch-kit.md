# Launch kit — Kingfisher 1.1.9

The copy prepared for first channels, for the current public release:
**Kingfisher 1.1.9** on the web and **Kingfisher 1.1.9** for macOS
...
> - **macOS** (`Kingfisher-1.1.9-arm64.dmg`) — Apple Silicon,
...
> **Title:** Kingfisher 1.1.9 — a local-first chess research
...
> (`Kingfisher-1.1.9-arm64.dmg`, Apple Silicon, macOS 13 or later,
...
> Kingfisher 1.1.9 — a local-first chess research workstation for
...
> **Title:** Kingfisher 1.1.9 — release notes
>
