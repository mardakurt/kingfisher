# Launch kit — Kingfisher 1.1.2

The copy prepared for first channels, for the current public release:
**Kingfisher 1.1.2** on the web and **Kingfisher 1.1.2** for macOS
...
> **Title:** Kingfisher 1.1.2 — a local-first chess research
...
> **Title:** Kingfisher 1.1.2 — release notes
>
