# Launch kit — Kingfisher 1.1.4

The copy prepared for first channels, for the current public release:
**Kingfisher 1.1.4** on the web and **Kingfisher 1.1.4** for macOS
...
> - **macOS** (`Kingfisher-1.1.4-arm64.dmg`) — Apple Silicon,
...
> **Title:** Kingfisher 1.1.4 — a local-first chess research
...
> (`Kingfisher-1.1.4-arm64.dmg`, Apple Silicon, macOS 13 or later,
...
> Kingfisher 1.1.4 — a local-first chess research workstation for
...
> **Title:** Kingfisher 1.1.4 — release notes
>
