# Launch kit — Kingfisher 1.3.0

The copy prepared for first channels, for the current public release:
**Kingfisher 1.3.0** on the web and **Kingfisher 1.3.0** for macOS
...
> - **macOS** (`Kingfisher-1.3.0-arm64.dmg`) — Apple Silicon,
...
> **Title:** Kingfisher 1.3.0 — a local-first chess research
...
> (`Kingfisher-1.3.0-arm64.dmg`, Apple Silicon, macOS 13 or later,
...
> Kingfisher 1.3.0 — a local-first chess research workstation for
...
> **Title:** Kingfisher 1.3.0 — release notes
>
