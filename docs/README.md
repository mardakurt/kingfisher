...
- [`release/1.1.6.md`](release/1.1.6.md) — release notes for the current
  public release. [`release/1.1.5.md`](release/1.1.5.md), [`release/1.1.4.md`](release/1.1.4.md), [`release/1.1.3.md`](release/1.1.3.md),
...
- [`reports/phase-53-handover.md`](reports/phase-53-handover.md) — the
  ...
  attempt at them, the 1.1.6 release and every gate run for it.
...
- [`release/1.0.0-rc.1.md`](release/1.0.0-rc.1.md),
  ...
  The current notes are [`release/1.1.6.md`](release/1.1.6.md).
