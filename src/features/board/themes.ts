...
export const BOARD_THEMES: readonly BoardTheme[] = [
  ...
  },
  {
    id: 'brown',
    name: 'Classic Brown',
    description: 'The printed diagram board. Warm, mid-contrast, and completely neutral.',
    light: '#f0d9b5',
    dark: '#b58863',
    pieceLight: '#fffdf8',
    pieceDark: '#231a12',
    coordinateOnLight: '#b58863',
    coordinateOnDark: '#f0d9b5',
    selected: 'rgb(120 82 36 / 0.44)',
    lastMove: 'rgb(205 173 74 / 0.42)',
    check: 'rgb(190 68 56 / 0.86)',
    legalMove: 'rgb(40 28 16 / 0.26)',
  },
  {
    id: 'maple',
    name: 'Maple',
    description: 'Pale tournament wood with a fine grain. The lightest of the wood boards.',
    grain: 0.75,
    light: '#f2e3c6',
    dark: '#c9a273',
    pieceLight: '#fffefa',
    pieceDark: '#2b2116',
    coordinateOnLight: '#c9a273',
    coordinateOnDark: '#f2e3c6',
    selected: 'rgb(150 106 44 / 0.4)',
    lastMove: 'rgb(184 142 62 / 0.34)',
    check: 'rgb(192 74 58 / 0.84)',
    legalMove: 'rgb(50 36 20 / 0.24)',
  },
  {
    id: 'midnight',
    name: 'Midnight',
    description: 'Deep blue-black. The quietest board in a dark room, and the least glare.',
    light: '#5b6b83',
    dark: '#2f3a4c',
    pieceLight: '#f3f6fb',
    pieceDark: '#080b12',
    coordinateOnLight: '#222934',
    coordinateOnDark: '#8494ab',
    selected: 'rgb(224 186 96 / 0.5)',
    lastMove: 'rgb(224 186 96 / 0.3)',
    check: 'rgb(226 96 86 / 0.82)',
    legalMove: 'rgb(226 233 244 / 0.24)',
  },
  {
    id: 'ivory',
    name: 'Ivory',
    description: 'Near-white with a whisper of separation. For printing and for bright rooms.',
    light: '#f7f4ec',
    dark: '#d6d0c2',
    pieceLight: '#ffffff',
    pieceDark: '#1a1814',
    coordinateOnLight: '#a9a294',
    coordinateOnDark: '#6f6a5e',
    selected: 'rgb(176 142 60 / 0.36)',
    lastMove: 'rgb(196 170 92 / 0.34)',
    check: 'rgb(198 74 62 / 0.8)',
    legalMove: 'rgb(60 54 42 / 0.24)',
  },
  {
    id: 'contrast',
    name: 'High Contrast',
