...
export const SETTINGS_INDEX: readonly SettingsEntry[] = [
  ...
  },
  {
    ...
    section: 'database',
    description:
      'Which databases Kingfisher queries, what each may answer, and the licence each carries.',
    keywords: [
      'source',
      'reference',
      'pack',
  ...
  {
    id: 'managed-engines',
    label: 'Install an engine',
    section: 'engine',
    description: 'Download and verify an open-source engine without leaving Kingfisher.',
    keywords: [
      'engine',
      'install',
      'download',
